  ...
  getTitleElement() {
    ...
    return (
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}} >
            ...
            {/* <IconDate name='date-range' size={15} style={{ marginLeft: 20,marginTop: 6 }} /> */}
                {/* <Image style={{width:15, height: 19,marginTop: 10,marginLeft: 10}} source={require('../../src/images/calender.png')}/> */}
                <Text style={{marginLeft: -20,textAlignVertical: 'center',paddingTop:6, fontSize:13, fontFamily: 'Montserrat-Medium' }} allowFontScaling={allowFontScaling}>
                  {this.getDateStr()}
               </Text>
            </View>
            <View>
